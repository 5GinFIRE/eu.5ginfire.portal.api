...
-->
  ...
  <xsl:template name="user.header.navigation">
    <table>
      <tr>
        <td style="width: 25%">
          <a href="http://www.forgebox.eu"><img src="images/logo.png" alt="FORGEBox Logo"></img></a>
          <br/>
  ...
  <xsl:template name="user.header.content">
    ...
    <div class="jetty-callout">
      ...
      <p>
		ssh2web widget, for forgebox project
      </p>
   </div>
  ...
  <xsl:template name="user.footer.navigation">
      ...
      <p>
            ...
            <span class="callout">
              <a href="http://localhost/documentation">Contribute to this documentation at

...
public class MANORouteBuilder  extends RouteBuilder{
	...
	public void configure() {
		...
		from("timer://checkAndUpdateRunningDeploymentDescriptors?delay=0m&period=120000").bean(MANOController.class,"checkAndUpdateRunningDeploymentDescriptors").stop();
